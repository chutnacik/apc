...
$(document).ready(function () {
  ...
  $(".banner-slider-thumbs .banner-slide-thumb").eq(0).addClass("slick-current");
  $(".banner-slider").on("afterChange", function (event, slick, currentSlide) {
    $(".banner-slider-thumbs .banner-slide-thumb")
      .removeClass("slick-current")
      .eq(currentSlide)
      .addClass("slick-current");
  });
  $(".banner-slider-thumbs .banner-slide-thumb").on("click", function () {
